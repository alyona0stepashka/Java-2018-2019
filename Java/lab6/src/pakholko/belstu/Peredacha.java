...
public class Peredacha extends TV {

    public Peredacha(String oil, int timenaliota, int salary, String Name, String level){
    ...
    public void UpgradeShturmovik (Peredacha temp) {
        temp.salary+=10;
