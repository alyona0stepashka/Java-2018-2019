...
public class Street {
    ...
    public synchronized void crossTheRoad() {
        ...
        System.out.println("Кол-во = " + this.countOfCars + ", направление " + (selectDirection?1:2));
        driveAway();
    }
    ...
    {
        if (!this.checkCarInFirstDirection())//если не пустое
        {
    ...
    {
        System.out.print("Уличные места:\nПервое направление { ");
